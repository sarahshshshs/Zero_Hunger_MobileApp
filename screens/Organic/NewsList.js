import {
  ...
  export default function NewsList() {
    ...
    const DatCollectinRef = collection(db, "News"); //firebase databse reference
        ...
        <FlatList
          ...
          renderItem={({ item }) => (
            ...
            >
              ...
              <Text style={styles.text}>Published By : {item.published}</Text>
              ...
              >
                ...
                <TouchableOpacity
                  ...
                  onPress={() => navigation.navigate("Update News", { item })}
